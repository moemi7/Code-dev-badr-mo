...
def crawler(app_id, continuation_token=None, epochs=10, start_date=None, batch_size=100, app=None):
    ...
    try:
        ...
        print("Couldn't finish collection.")
        print(e)
    finally:
...
def driverCrawler(app_name, app_id, epochs=10, start_date=None, batch_size=100, app=None):
...
if __name__ == "__main__":
    ...
    driverCrawler(app_name, app_id, start_date=start_date, app=app)
    sys.exit(app.exec())
